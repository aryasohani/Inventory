      ...
      <div className="rounded-2xl border border-border bg-card p-3">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 rounded-lg bg-input/40 border border-transparent focus:border-primary/50 text-sm outline-none"
          />
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    <td className="py-3 px-4">
                      <code className="text-primary font-medium">{p.id.toUpperCase()}</code>
                    </td>
                    ...
                    <td className="py-3 px-4 text-muted-foreground text-xs">
                      {format(new Date(p.expectedAt), "MMM d, yyyy")}
                    </td>
