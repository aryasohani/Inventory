        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          >
            ...
            <p className="text-muted-foreground mt-5 text-base leading-relaxed">
              AI-powered demand forecasting, vendor intelligence, and automation. Built for
              operators who don't want to babysit spreadsheets.
            </p>
            ...
            <div className="mt-10 space-y-3">
              {[
                ...
                <div key={s.k} className="flex items-center gap-4">
                  <div className="text-2xl font-display font-bold text-gradient-gold w-16">
                    {s.k}
                  </div>
          ...
          <div className="text-xs text-muted-foreground/60">
            © 2026 SmartStore AI · Enterprise grade
          </div>
        </div>
      </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-gradient-gold text-primary-foreground hover:opacity-90 shadow-glow font-semibold"
            >
              {loading ? (
                <>
          ...
          <div className="mt-7 pt-6 border-t border-border">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => quick("admin.e2e@smartstore.ai")}
                className="text-left rounded-lg border border-border p-2.5 hover:border-primary/40 transition-colors"
              >
                <div className="text-xs font-semibold">Admin (E2E)</div>
                <div className="text-[10px] text-muted-foreground truncate">
                  admin.e2e@smartstore.ai
                </div>
              </button>
              <button
                onClick={() => quick("staff.e2e@smartstore.ai")}
                className="text-left rounded-lg border border-border p-2.5 hover:border-primary/40 transition-colors"
              >
                <div className="text-xs font-semibold">Staff (E2E)</div>
                <div className="text-[10px] text-muted-foreground truncate">
                  staff.e2e@smartstore.ai
                </div>
              </button>
            </div>
          </div>
...
function Field({
  ...
  return (
    <label className="block">
      <div className="text-[11px] uppercase tracking-wider text-muted-foreground mb-1.5 font-semibold">
        {label}
      </div>
